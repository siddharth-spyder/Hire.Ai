# Hire.Ai
Hire.AI is a multi-agent AI hiring platform that evaluates candidates beyond the resume — scraping GitHub code, parsing resumes with Gemini AI, and scoring live interviews. Built with RAG, MongoDB, and Streamlit. Reduces hiring bias through evidence-based scoring.

#  [hire.ai — Beyond the Resume. The Full Picture.](https://youtu.be/UyyCoz3XT_A)
